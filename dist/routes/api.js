...
shoppingListRouter.post(paths_1.default.ShoppingList.Get, shoppingLists_1.createShoppingListValidation, shoppingList_1.createShoppingList);
shoppingListRouter.patch(paths_1.default.ShoppingList.Get, shoppingLists_1.createShoppingListValidation, shoppingList_1.updateShoppingList);
...
shoppingListRouter.delete(paths_1.default.ShoppingList.Members.Delete, shoppingLists_1.deleteMemberFromShoppingListValidation, shoppingList_1.deleteMemberFromShoppingList);
...
shoppingListRouter.patch(paths_1.default.ShoppingList.Items.Patch, shoppingLists_1.updateItemToShoppingListValidation, shoppingList_1.updateItemInShoppingList);
shoppingListRouter.delete(paths_1.default.ShoppingList.Items.Delete, shoppingLists_1.updateItemToShoppingListValidation, shoppingList_1.deleteItemFromShoppingList);
